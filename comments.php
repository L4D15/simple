	...
	<?php if ( have_comments() ) : ?>
		...
		<ol class="comment-list">
			<?php
				 ...
				 * to use simple_comment() to format the comments.
				 * If you want to override this in a child theme, then you can
				 * define simple_comment() and that will be used instead.
				 * See simple_comment() in inc/template-tags.php for more.
				 */
				wp_list_comments( array( 'callback' => 'simple_comment' ) );
			?>
		</ol><!-- .comment-list -->
